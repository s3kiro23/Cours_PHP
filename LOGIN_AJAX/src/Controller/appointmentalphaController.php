...
switch ($_POST['request']) {
    ...
    case 'checkUserFiles':
        ...
        $tab_files = $user->checkUploadedFiles();

        foreach ((array)$tab_files as $file) {

            $html .= HTML::displayFiles($file['file_name'], $file['id']);
    ...
    case 'showFile':
        ...
        $htmlType = HTML::showFileFrame('pdf', $_POST['fileID']);
        /*        error_log($htmlType);*/

        echo json_encode(array("htmlType" => $htmlType));
