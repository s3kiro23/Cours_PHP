...
<div class="container">
    <div class="row">
        <div class="col-6 mx-auto">
            <form class="flex gap-20 justify-content-center w-full py-3 mt-4 mx-auto rounded shadow border border-gray-300 bg-indigo-100 bg-gradient"
        ...
        <div class="col-6 mx-auto">
            <div class="flex-column justify-content-center w-full p-3 mt-4 mx-auto rounded shadow border border-gray-300 bg-indigo-100 bg-gradient">
                <div>
                    <h2 class="text-center font-weight-bold mb-4">Fichiers de l'utilisateur</h2>
                </div>
                <div class="flex-column rounded bg-white mb-4 py-2" id="userFiles">

                </div>
                <form id="uploadForm" action="javascript:uploadFile();" method="POST" class="flex flex-column">
                    <input name=file type=file id="file" class="mb-3"/>
                    <input id="submitBtn" class="mb-3 btn bg-indigo-600 text-white w-25" type="submit"
...
<div class="modal fade" id="modalSlot" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    ...
    <!-- Modal file -->
    <div class="modal fade" id="modalFile" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
         aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
